...
# 版本号里显示一个自己的名字（把 281677160 改成你自己名字就行了，不改的话，默认使用你仓库帐号）
sed -i "s/PTION='%D %V %C'/PTION='Compiled by 281677160 on $(TZ=UTC-8 date "+%Y/%m/%d") @ %D %V'/g" package/base-files/files/etc/openwrt_release
